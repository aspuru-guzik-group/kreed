...
def charge_is_OK(
    BO, AC, charge, DU, atomic_valence_electrons, atoms, valences,
...
def BO2mol(
    mol, BO_matrix, atoms, atomic_valence_electrons,
...
def set_atomic_charges(
    mol, atoms, atomic_valence_electrons,
...
def AC2mol(
    mol, AC, atoms, charge, allow_charged_fragments=True,
...
def xyz2mol(
    atoms, coordinates, charge=0, allow_charged_fragments=True,
