...
dataset = dataset[chunk * chunk_size : (chunk + 1) * chunk_size]
...
for i in range(0, len(all_samples), samples_per_example):
    ...
    all_samples_rebatched.append(collate_fn(items))

# all_samples_rebatched is a list of length N, where elements are batched Molecule objects
